Shader "Examples/DitheredTransparency"
{
    Properties
    {
        ...
        {}
        _ClipThreshold ("Threshold", Range(0, 1)) = 0.5
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                {
                16.0 / 17.0, 8.0 / 17.0, 14.0 / 17.0, 6.0
                / 17.0,
                4.0 / 17.0, 12.0 / 17.0, 2.0 / 17.0, 10.0
                / 17.0,
                13.0 / 17.0, 5.0 / 17.0, 15.0 / 17.0, 7.0
                / 17.0,
                1.0 / 17.0, 9.0 / 17.0, 3.0 / 17.0, 11.0
                / 17.0
                };
                uint index = (uint(screenUVs.x)%4)*4 +
                uint(screenUVs.y)%4;
                float threshold = ditherThresholds[index];
                clip(outputColor.a - threshold);
